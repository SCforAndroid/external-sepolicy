...
$IPTABLES -t security -A INPUT -i wlan0 -j SECMARK --selctx u:object_r:wlan_packet:s0
...
$IPTABLES -t security -A OUTPUT -o wlan0 -j SECMARK --selctx u:object_r:wlan_packet:s0
